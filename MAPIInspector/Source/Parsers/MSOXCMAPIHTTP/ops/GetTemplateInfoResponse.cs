...
namespace MAPIInspector.Parsers
{
    ...
    /// </summary>
    public class GetTemplateInfoResponse : Block
    {
        /// <summary>
        ...
        {
            var metaTags = new List<BlockString>();
            var additionalHeaders = new List<BlockString>();
            ...
            if (StatusCode == 0)
            {
                ...
                HasRow = ParseAs<byte, bool>();

                if (HasRow) Row = Parse<AddressBookPropertyValueList>();
            }
        ...
        {
            SetText("GetTemplateInfoResponse");
