...
{
    /// <summary>
    /// [MS-OXCROPS] 2.2.8.6.2 RopSetProperties ROP Success Response Buffer
    /// [MS-OXCROPS] 2.2.8.6.3 RopSetProperties ROP Failure Response Buffer
