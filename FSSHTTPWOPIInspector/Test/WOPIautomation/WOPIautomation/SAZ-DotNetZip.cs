...
namespace Fiddler
{
    ...
    class DNZSAZProvider : FiddlerCore.Fiddler.ISAZProvider
    {
        ...
        public FiddlerCore.Fiddler.ISAZWriter CreateSAZ(string sFilename)
        {
            return new DNZSAZWriter(sFilename);
        }

        public FiddlerCore.Fiddler.ISAZReader LoadSAZ(string sFilename)
        {
    ...
    class DNZSAZReader : FiddlerCore.Fiddler.ISAZReader
    {
        ...
        RetryWithPassword:
            ...
            catch (Exception eX)
            {
                ...
                FiddlerCore.Fiddler.FiddlerApplication.ReportException(eX, "Error saving SAZ");
            }
        ...
        public byte[] GetFileBytes(string sFilename)
        {
            ...
            byte[] arrData = FiddlerCore.Fiddler.Utilities.ReadEntireStream(strmBytes);
            strmBytes.Close();
            return arrData;
        }
    ...
    class DNZSAZWriter : FiddlerCore.Fiddler.ISAZWriter
    {
        private ZipFile _oZip;
        private string _sFilename;
        ...
        public void AddFile(string sFilename, FiddlerCore.Fiddler.SAZWriterDelegate oSWD)
        {
...
#region PasswordProtectIfNeeded
            ...
            {
                if (FiddlerCore.Fiddler.CONFIG.bUseAESForSAZ)
                {
                    if (FiddlerCore.Fiddler.FiddlerApplication.Prefs.GetBoolPref("fiddler.saz.AES.Use256Bit", false))
                    {
